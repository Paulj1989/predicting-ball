...
class TestRunCoverageTest:
    ...
    def test_returns_float_between_zero_and_one(
        self, sample_bootstrap_params, small_test_data
    ):
    ...
    def test_higher_confidence_higher_coverage(self, sample_bootstrap_params, small_test_data):
...
class TestDiagnoseBootstrapLambdaDistribution:
    ...
    def test_returns_diagnostics_dict(self, sample_bootstrap_params, small_test_data):
    ...
    def test_mean_lambda_positive(self, sample_bootstrap_params, small_test_data):
...
class TestCoverageByConfidenceLevel:
    ...
    def test_returns_dict(self, sample_bootstrap_params, small_test_data):
    ...
    def test_all_coverages_valid(self, sample_bootstrap_params, small_test_data):
